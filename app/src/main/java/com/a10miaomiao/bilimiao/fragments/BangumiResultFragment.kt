...
import com.a10miaomiao.bilimiao.adapter.BangumiResultAdapter
...
class BangumiResultFragment : BaseFragment() {
    ...
    override fun finishCreateView(savedInstanceState: Bundle?) {
        ...
        mAdapter?.setOnItemClickListener { adapter, view, position ->
            IntentHandlerUtil.openWithPlayer(activity, "http://bangumi.bilibili.com/anime/${archives[position].param}/")
        }
