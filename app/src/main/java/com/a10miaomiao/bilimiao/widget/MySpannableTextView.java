...
public class MySpannableTextView extends AppCompatTextView {
    ...
    public MySpannableTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        limitTextViewString(this.getText().toString(), 140, this, v -> {
            //设置监听函数
        });
    }
    ...
    public void setLimitText(String text) {
        limitTextViewString(text, 48, this, v -> {
            //设置监听函数
        });
    }
            ...
            if (n != m) {
                ...
                mSpanALL.setSpan(new ClickableSpan() {
                    ...
                    public void updateDrawState(TextPaint ds) {
                        ...
                        ds.setColor(textView.getResources().getColor(ThemeHelper.INSTANCE.getColorAccent(textView.getContext())));
                    ...
                    public void onClick(View widget) {
                        IntentHandlerUtil.INSTANCE.openWithPlayer(((Activity) getContext())
                                , IntentHandlerUtil.INSTANCE.getTYPE_VIDEO()
                                , explicitTextAll.substring(finalM + 2, finalN));
                    }
