 ...
 */
class KeyWordDB(context: Context, name: String, factory: SQLiteDatabase.CursorFactory?, version: Int) :
        SQLiteOpenHelper(context,name,factory,version){

    companion object{
        val DB_NAME = "PreventKeyWord_db"
        val TABLE_NAME = "PreventKeyWord"
    }

    private val CREATE_TABLE = "create table if not exists $TABLE_NAME (id integer primary key autoincrement,keyword text)"
